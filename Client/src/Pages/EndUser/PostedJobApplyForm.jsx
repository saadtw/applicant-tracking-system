...
function PostedJobApplyForm() {
  ...
  const submit = async (e) => {
    ...
    const options = {
      url: "https://Applicant Tracking System-fyp-production.up.railway.app/job/apply-to-job",
      method: "POST",
      headers: {
  ...
  return (
    <div>
      ...
      <footer className="bg-gray-700 h-12 flex justify-center items-center">
        <h3 className="text-white line1">Powerd By Applicant Tracking System </h3>
      </footer>
    </div>
  );
}
