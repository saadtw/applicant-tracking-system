...
function HomePage() {
  ...
  const CheckAuth = async () => {
    axios
      .post(
        "https://Applicant Tracking System-fyp-production.up.railway.app/home",
        {},
        {
          headers: {
  ...
  const CheckOrganization = async () => {
    ...
    axios
      .post("https://Applicant Tracking System-fyp-production.up.railway.app/dashboard", {
        headers: {
          ...
          {profileSetup == false ? (
            ...
            <>
              <h1 className="heading1 ml-12  mt-20 text-transparent text-3xl sm:text-6xl bg-clip-text bg-gradient-to-r from-blue-500 to-black">
                Welcome to Applicant Tracking System
              </h1>
