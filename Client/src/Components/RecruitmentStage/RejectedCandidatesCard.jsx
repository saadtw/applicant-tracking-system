...
function RejectedCandidateCard({ id }) {
  ...
  useEffect(() => {
    const getCandidates = async () => {
      const options = {
        url: "https://Applicant Tracking System-fyp-production.up.railway.app/details/active/rejected",
        method: "POST",
        headers: {
  ...
  const handleEmail = async () => {
    ...
    if (candidate.length !== 0) {
      ...
      // axios POST request
      const options = {
        url: "https://Applicant Tracking System-fyp-production.up.railway.app/details/active/hired/sendEmail",
        method: "POST",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json;charset=UTF-8",
