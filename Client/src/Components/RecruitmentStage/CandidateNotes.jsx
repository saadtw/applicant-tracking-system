...
function CandidateNotes({ id }) {
  ...
  const updateComment = () => {
    // axios POST request
    const options = {
      url: "https://Applicant Tracking System-fyp-production.up.railway.app/details/active/user/patch/comments",
      method: "PATCH",
      headers: {
  ...
  const postComments = () => {
    // axios POST request
    const options = {
      url: "https://Applicant Tracking System-fyp-production.up.railway.app/details/active/user/add/comments",
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json;charset=UTF-8",
  ...
  useEffect(() => {
    ...
    const getComments = () => {
      // axios GET request
      const options = {
        url: "https://Applicant Tracking System-fyp-production.up.railway.app/details/active/user/get/comments",
        method: "POST",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json;charset=UTF-8",
