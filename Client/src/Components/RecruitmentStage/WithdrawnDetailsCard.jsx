...
function WithdrawnDetailsCard({ id }) {
  ...
  useEffect(() => {
    // axios POST request
    const options = {
      url: "https://Applicant Tracking System-fyp-production.up.railway.app/details/active/withdrawn/details",
      method: "POST",
      headers: {
  ...
  const handleTextValue = () => {
    // axios POST request
    const options = {
      url: "https://Applicant Tracking System-fyp-production.up.railway.app/details/active/withdrawn/details/updateReason",
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json;charset=UTF-8",
