...
function CreateJobHeadaer({ setData }) {
  ...
  const filterShowClosedJobs = () => {
    // axios POST request
    const options = {
      url: "https://Applicant Tracking System-fyp-production.up.railway.app/job/get-jobs/closed",
      method: "POST",
      headers: {
  ...
  const filterShowActiveJobs = () => {
    // axios POST request
    const options = {
      url: "https://Applicant Tracking System-fyp-production.up.railway.app/job/get-jobs/active",
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json;charset=UTF-8",
