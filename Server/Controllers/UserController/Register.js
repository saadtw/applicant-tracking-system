        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">
                Dear <b> `+ name + `</b> you applied for Applicant Tracking System.
For account verification this link has been sent kindly click on verify  button to verify your account. 
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <a href="https://Applicant Tracking System-fyp-production.up.railway.app/verify?id=`+ id + `" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Verify Now</a>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
              <p style="margin: 0;"><b>Applicant Tracking System</b><br> ATS System</p>
            </td>
          </tr>
          <!-- end copy -->
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Account Activation [Applicant Tracking System]',
      html: htmlCode,
    };
